...
export const ORIENTATION_FACTORS: Record<number, number> = {
  0: 0.55,
  45: 0.75,
  90: 0.85,
  135: 0.95,
...
export function getOrientationFactor(degrees: number): number {
...
export function getPitchFactor(degrees: number): number {
...
export function getDayOfYear(month: number): number {
