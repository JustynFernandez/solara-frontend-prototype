...
const HipRoof = () => {
    ...
    return (_jsxs("group", { children: [_jsx("mesh", { geometry: geometry, receiveShadow: true, castShadow: true, children: _jsx("meshStandardMaterial", { color: "#4a5568", roughness: 0.8, metalness: 0.1, side: THREE.DoubleSide }) }), _jsxs("mesh", { position: [-(width / 4), slopeData.roofHeight / 2 + 0.003, 0], rotation: [0, 0, slopeData.pitchRad], children: [_jsx("planeGeometry", { args: [slopeData.slopeLength - 0.2, depth - 0.3] }), _jsx("meshStandardMaterial", { color: "#64748b", roughness: 0.9, transparent: true, opacity: 0.15, side: THREE.DoubleSide })] }), _jsxs("mesh", { position: [(width / 4), slopeData.roofHeight / 2 + 0.003, 0], rotation: [0, 0, -slopeData.pitchRad], children: [_jsx("planeGeometry", { args: [slopeData.slopeLength - 0.2, depth - 0.3] }), _jsx("meshStandardMaterial", { color: "#64748b", roughness: 0.9, transparent: true, opacity: 0.15, side: THREE.DoubleSide })] })] }));
};
