...
const SolarParticles = ({ className = "" }) => {
    ...
    if (!motionEnabled || !ready)
        return null;
    return (_jsx("div", { className: className, "aria-hidden": true, children: _jsx(Particles, { id: "solara-solar-particles", options: options, className: "h-full w-full" }) }));
};
