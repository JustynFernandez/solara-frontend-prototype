    ...
    <div ref={sectionRef} className="overflow-x-hidden transition-colors duration-700 ease-in-out">
      <section className="relative flex min-h-[100dvh] flex-col items-center justify-start">
        <div className="relative flex min-h-[100dvh] w-full flex-col items-center">
          ...
          >
            <img src={bgImageSrc} alt="Background" className="h-screen w-screen object-cover object-center" loading="eager" />
          ...
          <div className="relative z-10 flex w-full flex-col items-center justify-start">
            <div className="relative flex h-[100dvh] w-full flex-col items-center justify-center">
              ...
              >
                {mediaType === "video" ? (
                  mediaSrc.includes("youtube.com") ? (
                    <div className="relative h-full w-full pointer-events-none">
                      <iframe
                        ...
                        allowFullScreen
                        style={{ borderRadius: `${mediaRadius}px` }}
                      />
                  ...
                  <div className="relative h-full w-full">
                    <img src={mediaSrc} alt={title || "Media content"} className="h-full w-full object-cover" loading="eager" style={{ borderRadius: `${mediaRadius}px` }} />
                    <motion.div
                ...
                <div className="relative z-10 mt-4 flex flex-col items-center text-center transition-none">
                  {date && (
                    <p className="text-2xl text-white/80" style={{ transform: `translateX(-${textTranslateX}vw)` }}>
                      {date}
                    </p>
                  )}
                  {scrollToExpand && (
                    <p className="text-center text-white/80" style={{ transform: `translateX(${textTranslateX}vw)` }}>
                      {scrollToExpand}
                    </p>
                  )}
                </div>
              ...
              >
                <motion.h2
                  className="text-4xl font-semibold text-white/90 transition-none md:text-5xl lg:text-6xl"
                  style={{ transform: `translateX(-${textTranslateX}vw)` }}
                >
                  {firstWord}
                </motion.h2>
                <motion.h2
                  className="text-center text-4xl font-semibold text-white/90 transition-none md:text-5xl lg:text-6xl"
                  style={{ transform: `translateX(${textTranslateX}vw)` }}
                >
                  {restOfTitle}
                </motion.h2>
